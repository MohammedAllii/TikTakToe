...
public class WinODialog extends Dialog {

    private final String messagee;
    private final  MainActivity mainActivity;
    public WinODialog(@NonNull Context context, String messagee, MainActivity mainActivity) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.win_o_dialog_layout);
